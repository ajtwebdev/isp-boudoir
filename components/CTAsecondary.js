...
const Wrapper = styled.div`
  background: url("https://staging.innerspiritboudoir.com/wp-content/uploads/2023/09/book-cta-tame-scaled.jpg"),
    rgba(0, 0, 0, 0.2);
      ...
      <Section>
        <Container>
          <Text className="spacing">
            ...
            <p>
              A beauty photography session can empower you to start feeling

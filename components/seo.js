...
export default function Seo({
  title = "Inner Spirit Photography | Calgary Beauty",
  description = "Inner Spirit Photography is a Calgary-based beauty studio with more than 40 years of experience.",

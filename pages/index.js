  ...
  return (
    <LayoutJs>
      <Seo
        ...
        description="Encouraging, supportive, life-changing. Calgary photography to build your self-esteem, love yourself more deeply, and see how amazing you truly are!"
      />
      <HeroBasic />
      <Stats />
      <HomeMain />
          ...
          <Flex>
            <div className="spacing">
              <h2 className="headline">
                Looking for an encouraging and supportive experience?{" "}
              </h2>
